...
from transformers import (
    ...
    Qwen3Config,        # ← will raise ImportError on TF < 4.51
    Qwen3Model,
    Qwen3ForCausalLM,
)
...
# -----------------------------------------------------------------------------  
# 3.  CAUSAL-LM HEAD WRAPPER
# -----------------------------------------------------------------------------  
class LlavaQwen3ForCausalLM(Qwen3ForCausalLM, LlavaMetaForCausalLM):
    """
    Qwen-3 + LLaVA vision adapter (no changes beyond mix-ins).
    """
    config_class = LlavaQwen3Config

    def __init__(self, config: Qwen3Config):
        # initialise base Qwen-3 LM
        super(Qwen3ForCausalLM, self).__init__(config)
        self.model = LlavaQwen3Model(config)                # swap backbone
...
# -----------------------------------------------------------------------------  
# 4.  (DE-)REGISTRATION WITH HF AUTOMAP
# -----------------------------------------------------------------------------  
